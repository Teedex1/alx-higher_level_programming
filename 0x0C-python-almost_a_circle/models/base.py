...
class Base:
    ...
    This is the base for all classes in project 0x0C*.
    ...
    def load_from_file(cls):
        """Return a list of classesinstanted from a file of JSON strings.

        Reads from `<cls.__name__>.json`.

        Returns:
            If the file does not exist - an empyt list.
            Otherwise - a list of instantied classes.
        """
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): A list of Rectabgle objects to draw.
